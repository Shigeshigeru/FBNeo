...
static struct BurnRomInfo DrvjcRomDesc[] = {
	{ "bm01bc.12d",    0x08000, 0x9ff9667e, BRF_ESS | BRF_PRG }, //  0	Z80 #1 Program Code
	{ "bm02bc.13d",    0x10000, 0x085441b6, BRF_ESS | BRF_PRG }, //	 1
	{ "bm03bc.14d",     0x10000, 0x2c38029e, BRF_ESS | BRF_PRG }, //	 2
...
//Capcom Arcade Stadium 2 Version
struct BurnDriver BurnDrvNineteen43jc = {
	"1943jc", "1943", NULL, NULL, "1987",
	"1943: Midway Kaisen (Japan, CAS2 Version, Rev B)\0", NULL, "Capcom", "Miscellaneous",
	L"1943: \u30DF\u30C3\u30C9\u30A6\u30A7\u30A4\u6D77\u6226 (Japan,CAS2 Version, Rev B)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VERSHOOT, 0,
	NULL, DrvjcRomInfo, DrvjcRomName, NULL, NULL, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&DrvRecalc, 0x380, 224, 256, 3, 4
};
